...
## Inputs esperados
- Diff de la feature.
- `progress/<id>/design.md` (en concreto la sección "API contract" si
  aplica).
...
6. Ejecuta los ejemplos relacionados con el cambio y captura el output
   en `progress/<id>/examples-run.md`.

## Output
- Ejemplos nuevos o actualizados en la carpeta convencional.
- `progress/<id>/examples-run.md` con los outputs verificados.
- Sub-sección **`## Examples updates`** anexada a
  `progress/<id>/archive.md` con la lista de ejemplos
