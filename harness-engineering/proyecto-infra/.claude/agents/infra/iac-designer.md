...
## Inputs esperados
- `progress/<id>/spec.md`.
- `progress/<id>/proposal.md` aprobada en GATE#1.
...
6. Anexa "IaC design" a `progress/<id>/design.md` con: grafo de módulos,
   state backend, secrets, blast radius, rollback plan.

## Output
- Sección **`## IaC design`** anexada a `progress/<id>/design.md` con:
