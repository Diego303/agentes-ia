...
- Diff completo desde el último estado limpio (post-design, pre-
  implementer).
- `progress/<id>/design.md` (incluyendo "Testing strategy" y "API
  contract" si existen).
- `progress/<id>/spec.md`.
...
6. Escribe `progress/<id>/code-review.md` con secciones: Resumen,
